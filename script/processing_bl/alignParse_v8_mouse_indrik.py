...
#infilePaths = [directory+corefilename+'_zeroMM.map', directory+corefilename+'_oneMM.map', directory+corefilename+'_twoMM.map',directory+corefilename+'_threeMM.map']
#infilePaths = [directory+'_zeroMM.map', directory+'_oneMM.map', directory+'_twoMM.map']
infilePaths = [directory+corefilename+'_MM.map']
