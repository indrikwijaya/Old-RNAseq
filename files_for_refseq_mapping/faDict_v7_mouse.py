...
######################################################################################################
def getChromCollatedKeys(chrom, directory):
    #refseqCoordDirectory = '/home/hguo/Documents/indexes/refseq/mm9/chromGenes_160617_mouse/'
    refseqCoordDirectory = '/home/hguo/Documents/indexes/mm9/refseq/chromGenes_160617_mouse/'
    fafile = refseqCoordDirectory+chrom+'_genes.fa'
    rfCoordfile = refseqCoordDirectory+chrom+'_refseqCoords.txt'
...
for chrom in chromosomes:
    collatedKeyToReadNum, chromAlign = getChromCollatedKeys(chrom, directory)
